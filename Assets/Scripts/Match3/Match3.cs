...
public class Match3 : MonoBehaviour
{
        ...
        for(int i = 0; i < finishedUpdating.Count; i++)
        {
            ...
            if(connected.Count == 0)
            {
                ...
                foreach(Point pnt in connected) {
                    ...
                    if(nodePiece != null) nodePiece.gameObject.SetActive(false);
                    node.SetPiece(null);
                }
            }
    ...
    int newValue(ref List<int> remove) {
        ...
        for(int i = 0; i < pieces.Length; i++) available.Add(i + 1);
    ...
    public Vector2 getPositionFromPoint(Point p) {
        return new Vector2(100 * p.x, -100 * p.y);
    }
}
...
public class Node
{
	public int value; //0 = blank; 1 = orange; 2 = red; 3 = blue; 4 = green; 5 = pink; -1 = hole.
	public Point index;
    NodePiece piece;
